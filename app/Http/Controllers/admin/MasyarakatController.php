...
class MasyarakatController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            'nik' => 'required|max:16|unique:data_penduduk,nik',
        ...
        \App\Models\Penduduk::create($validatedData);
        ...
        return redirect('/data-penduduk')->with('successCreatedPenduduk', 'Data dan akun berhasil dibuat');
    }
