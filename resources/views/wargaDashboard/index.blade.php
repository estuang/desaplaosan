    ...
    <div class="row">
        ...
        <div class="card w-80 mb-2">
            <div class="card-body">
                ...
                <h6>WEBSITE SISTEM MANAJEMEN LAYANAN MASYARAKAT DESA PLAOSAN</h6>
            </div>
        </div>
        <div></div>
        <div class="card w-80 mb-2">
            <div class="card-body">
                ...
                <h6 style="color: #ff0000"><b> Gunakan password yang mudah diingat. Lebih baik gunakan huruf, angka, dan karakter!!!
                    </b></h6>
