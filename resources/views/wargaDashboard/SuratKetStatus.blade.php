                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{route('warga/surat-keterangan-status/store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="no_surat_sks" class="form-label"><b>No. Surat SKS</b></label>

                                    <input type="text" name="no_surat_sks" id="no_surat_sks" class="form-control @error('no_surat_sks') is-invalid @enderror" required value="{{ old('no_surat_sks') }}" autocomplete="off" placeholder="Input Keperluan SKS">
