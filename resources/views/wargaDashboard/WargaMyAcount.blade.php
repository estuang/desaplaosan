                            ...
                            <form action="{{route('Warga/Update/Account',$user->id)}}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" required value="{{ old('alamat', $user->alamat) }}" placeholder="Input alamat">
                                        @error('alamat')
                                        <div class="invalid-feedback">
                                            <p style="text-align: left">{{ $message }}</p>
                                        </div>
