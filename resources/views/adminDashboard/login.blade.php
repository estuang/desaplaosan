...
<body class="text-center">
    ...
    <main class="form-signin w-65 m-auto">
        ...
        <form action="/authenticate" method="POST">
            ...
            <div class="d-flex justify-content-center px-2"><img src="{{asset('sides.png')}}" id="foto" alt="Logo" height="192px" /></div>
            ...
            <p>
                Click <a href="{{ route('register') }}">disini</a> jika anda belum punya akun?
            </p>
            <p class="mt-4">
